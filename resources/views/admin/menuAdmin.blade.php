        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="url('/admin/danh-muc')">
                        {{ __('Danh mục') }}
                    </x-nav-link>

                    <x-nav-link :href="url('/admin/san-pham')">
                        {{ __('Sản phẩm') }}
                    </x-nav-link>

                    <x-nav-link :href="url('/admin/don-hang')">
                        {{ __('Đơn hàng') }}
                    </x-nav-link>
                    ...
                    <x-slot name="content">
                        @if (Route::has('login'))
                            @auth
                                ...
                                <x-dropdown-link :href="route('admin.profile.edit')">Thông tin tài khoản</x-dropdown-link>
