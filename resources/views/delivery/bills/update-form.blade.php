...
@section('content')
    ...
    class="block mx-auto max-w-2xl rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        <form action=" {{ url('/delivery/updatebill/'.$bill[0]->bill_id) }} " method="post" class="">
                ...
                <div class="flex">
                    ...
                    <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                        <input
                            ...
                            name="bill_paystatus"
                            id="pay-false"
                            value="0" @if ($bill[0]->bill_paystatus == 0) checked @endif/>
                        <label
                    ...
                    <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                        <input
                            ...
                            name="bill_paystatus"
                            id="pay-true"
                            value="1" @if ($bill[0]->bill_paystatus == 1) checked @endif/>
                        <label
                            class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                            for="pay-true"
                            >Đã thanh toán</label
                ...
                <div class="flex">
                    ...
                    <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                        <input
                            ...
                            name="bill_status"
                            id="shipped-false"
                            value="0" @if ($bill[0]->bill_status == 0) checked @endif/>
                        <label
                            class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                            for="shipped-false"
                            >Chưa giao hàng</label
                        >
                    </div>
                    ...
                    <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                        <input
                            ...
                            name="bill_status"
                            id="shipped-true"
                            value="1" @if ($bill[0]->bill_status == 1) checked @endif/>
                        <label
                            class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                            for="shipped-true"
                            >Đã giao hàng</label
